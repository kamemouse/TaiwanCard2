...
namespace Kyusyukeigo.Helper
{
    public class GameViewSizeHelper
    {
        ...
        static Type gameViewSizeType = Type.GetType("UnityEditor.GameViewSizeType" + "," + assemblyName);
        static Type gameViewSize = Type.GetType("UnityEditor.GameViewSize" + "," + assemblyName);
        static Type gameViewSizes = Type.GetType("UnityEditor.ScriptableSingleton`1" + "," + assemblyName).MakeGenericType(Type.GetType("UnityEditor.GameViewSizes" + "," + assemblyName));
        ...
        {
            EditorWindow gameView = EditorWindow.GetWindow(Type.GetType("UnityEditor.GameView" + "," + assemblyName));
            PropertyInfo currentSizeGroupType = Type.GetType("UnityEditor.GameView" + "," + assemblyName).GetProperty("currentSizeGroupType", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Static);
            ...
            if (index != -1)
            {
                PropertyInfo selectedSizeIndex = Type.GetType("UnityEditor.GameView" + "," + assemblyName).GetProperty("selectedSizeIndex", BindingFlags.Instance | BindingFlags.NonPublic);
